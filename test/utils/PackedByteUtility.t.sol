...
contract PackedByteUtilityTest is Test {
    function testGetPackedBytesFromRight() public {
        ...
        expected = 0x2;
        actual = PackedByteUtility.getPackedByteFromRight(1, bitField);
        assertEq(actual, expected);
        expected = 0x0;
        actual = PackedByteUtility.getPackedByteFromRight(2, bitField);
        assertEq(actual, expected);
        expected = 0xff;
        actual = PackedByteUtility.getPackedByteFromRight(31, bitField);
        assertEq(actual, expected);

        uint256 bitFieldShort = 0x311;
        expected = 0x11;
        actual = PackedByteUtility.getPackedByteFromRight(0, bitFieldShort);
        assertEq(actual, expected);
        expected = 0x3;
        actual = PackedByteUtility.getPackedByteFromRight(1, bitFieldShort);
        assertEq(actual, expected);
        expected = 0x0;
        actual = PackedByteUtility.getPackedByteFromRight(2, bitFieldShort);
        assertEq(actual, expected);
        expected = 0x0;
        actual = PackedByteUtility.getPackedByteFromRight(31, bitFieldShort);
    }
    ...
    function testGetPackedBytesFromLeft() public {
        ...
        assertEq(actual, expected);
        expected = 0x1;
        actual = PackedByteUtility.getPackedByteFromLeft(1, bitField);
        assertEq(actual, expected);
        expected = 0x0;
        actual = PackedByteUtility.getPackedByteFromLeft(2, bitField);
        assertEq(actual, expected);
        expected = 0xff;
        ...
        assertEq(actual, expected);
        expected = 0x11;
        actual = PackedByteUtility.getPackedByteFromLeft(1, bitFieldShort);
        assertEq(actual, expected);
        expected = 0x0;
        actual = PackedByteUtility.getPackedByteFromLeft(2, bitFieldShort);
        assertEq(actual, expected);
        expected = 0x0;
        actual = PackedByteUtility.getPackedByteFromLeft(31, bitFieldShort);
    }

    function testUnpackBytes() public {
        uint256 packed = 0x0;
        uint256 expected = 0x0;
        uint256 actual = PackedByteUtility.unpackBytesToBitField(packed);
        assertEq(actual, expected);
    ...
    function testPackBytearray() public {
        uint8[] memory bytearray = new uint8[](1);
        bytearray[0] = 0;
